...
class LinearGradient extends Component {
  render() {
    ...
    console.log("color0 props", this.props);
    return (
...
// take the AnimatedGradient above and create a function component
const AnimatedGradient = ({
  ...
  const interpolatedColors = [color0, color1].map((animatedColor, index) => {
    console.log("animatedColor", animatedColor);
    console.log("preferColors[index]", preferColors[index]);
    console.log("preferColors", preferColors);
    console.log(
      "array from length",
      Array.from({ length: customColors.length + 1 }, (v, k) => k)
    );

    console.log("before inter", inter);
  ...
  console.log("interpolatedColors", interpolatedColors[0], "thats it");

  // console.log("\n\ninputted colors", color0, color1, "\n\n");
